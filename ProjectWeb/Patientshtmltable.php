...
<head>
    ...
    <link rel="stylesheet" href="patientstable.css">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <td>" . $row["Cpassword"] . "</td>
                <td>
                    <a class='btn btn-primary btn-sm' href='Update.php?PatientSSN=" . $PatientSSN . "'>Update</a>
                    <a class='btn btn-primary btn-sm' href='delete.php?PatientSSN=" . $PatientSSN . "'>Delete</a>
                </td>
                </tr>";
            }
            ?>
