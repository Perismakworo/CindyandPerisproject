...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="pharmacisttable.css">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <td>" . $row["Cpassword"] . "</td>
                <td>
                    <a class='btn btn-primary btn-sm' href='pharmacistupdate.php?Pharmacistid=" . $Pharmacistid . "'>Update</a>
                    <a class='btn btn-primary btn-sm' href='pharmacistdelete.php?Pharmacistid=" . $Pharmacistid . "'>Delete</a>
                </td>
                </tr>";
            }
            ?>
